  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{ route('merch') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-shop text-dark text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Data Merchandise</span>
          </a>
        </li>
...
<img src="{{ asset('assets/img/marie.jpg') }}" alt="profile" style="width: 30px; border-radius: 100%; ">&nbsp;&nbsp;
    ...
    <!-- End Navbar -->
      @yield('content')
    <footer class="footer pt-3 position-fixed bottom-5 w-80">
...
<!-- Optional: Toast untuk success message -->
@if(session('success'))
<script>
    Swal.fire({
        icon: 'success',
